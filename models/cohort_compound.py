...
class CohortCompound(base.Base):
    ...
    __table_args__ = (
        UniqueConstraint(
            "cohort_id", "local_compound_id", name="uniq_cohort_id_local_compound_id"), Index(
            "ix_cohort_compound_on_cohort_id_mz", "cohort_id", "mz"), Index(
                "ix_cohort_compound_on_cohort_id_rt", "cohort_id", "rt"), )
